...
if(isset($_POST["admlog"])){
	$an=$_POST["uname"];
	$psn=$_POST["pass"];
	$sql= "select * from Admin where name='$an'";
...
<div style="border-radius: 15px; position: absolute; background-color: rgba(38,21,30,.5); width: fit-content; height: fit-content; left: 60%; top: 36%; padding: 25px 25px 25px 25px;">
	...
	<form action="" method="post">
		<table>
			...
			<tr>
				<td colspan="2"><center><input type="submit" name="admlog" value="LOGIN"></center></td>
			</tr>
            <tr>
                <td colspan="2"><a href="signin.php" style="color: darkgoldenrod">User?</a></td>
            </tr>
		</table>
